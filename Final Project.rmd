...
## Landfill RNG Project Locations
...
project_graph_geo = plot_geo(landfillgas_count_by_geo,
               locationmode = "USA-states",
               sizes = c(1, 250)) %>% 
  add_markers(x = ~longitude, y = ~latitude,
              size = ~n, color=~n,
              hoverinfo = "text", fill = ~"",
              text = ~paste(landfillgas_count_by_geo$landfill_name)) %>%
  layout(title = "Landfill RNG Projects", geo = g)
